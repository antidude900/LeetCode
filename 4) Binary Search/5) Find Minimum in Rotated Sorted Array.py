...
If the mid is less than the element towards it, then it is in sorted order meaning its not of the rotated part. So we can be asuured that all the elements between will also be less.
