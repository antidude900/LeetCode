...
Also for the square, we require 2 indicies for its location and as we are using the key for storing the index, 
we cannot use list for keys so we use tuples as keys for storing the 2 index.
